        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900">
              Review: {car.make} {car.model}
            </h1>
            <p className="text-sm text-gray-500">
              Scan ID: {scan.id} &bull; Confidence:{" "}
          ...
          <div className="flex-1 relative rounded overflow-hidden border border-gray-200 bg-black">
            ...
            {showOverlay &&
              scan.detectedDamage?.map((box, i) => (
                <div
                  key={i}
                  className="border-2 border-red-500 bg-red-500/20 cursor-pointer hover:bg-red-500/40 transition-colors"
